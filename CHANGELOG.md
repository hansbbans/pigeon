...
- Fresh Worker instances now honor the stored database schema version and use an indexed one-time sync backfill, preventing repeated full-library scans from exhausting D1 reads.
